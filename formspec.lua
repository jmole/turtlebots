...
local function cbutton(x, y, name)
    ...
    return item_image_button(x, y, 1, 1, name)
end
...
local function panel_commands()
    local commands = {
        ...
        { "turn_clockwise", "turn_anticlockwise", "turn_random", "move_left", "move_right" },
    ...
    local panel = highlight(0, 1.5, 6, 7, "a", "a", "f")
...
local function draw_subroutines(pos, program)
    ...
    for i = 0, 6 do
        ...
        subroutines = subroutines
            .. padded_list("nodemeta:" .. pos, "p" .. i, 8, i + 1.5, VBOTS.INVENTORY_SIZE, 1)
